...
def buy():
    ...
    if request.method == "GET":
        ...
        flash("You just bought " + str(shares) + " shares of " +
              stock["symbol"] + " for $" + str(round(int(shares) * stock["price"], 2)))
...
def add_cash():
    ...
    if request.method == "GET":
        ...
        if not new_cash:
            return apology("Provide a valid amount of money")
        ...
        flash("You just added $" + str(new_cash) + " to your account")
...
def register():
    ...
    if request.method == "GET":
        ...
        if not confirmation:
            return apology("Repeat your password")
...
def sell():
    ...
    if request.method == "GET":
        ...
        if not shares or shares <= 0:
            return apology("You can not buy that amount of shares")
        ...
        flash("You just sold " + str(shares) + " shares of " + stock["symbol"] + " for $" + str(shares * stock["price"]))
